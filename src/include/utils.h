...
// Table 2 answer-noise parameter. Keep the implementation and documentation
// tied to this single definition.
constexpr double ANSWER_NOISE_SIGMA = static_cast<double>(1ULL << 22);

using namespace std;
using namespace CryptoPP;

// Cryptographically secure randomness backed by Crypto++ AutoSeededRandomPool.
// SecureRandomUint64Below uses rejection sampling and is unbiased.
